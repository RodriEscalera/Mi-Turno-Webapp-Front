...
import SuccessChange from "../commons/alerts/SuccessChange";
...
function ChangePassword() {
  ...
  const handleSubmit = async (
    ...
    const changePasswordQuery = await axios
      .post("http://localhost:3001/api/users/changePassword", {
        id,
        token,
        newPassword,
      })
  ...
  return (
    <>
      ...
      {showModal === 1 ? <SuccessChange /> : null}
    </>
  );
}
